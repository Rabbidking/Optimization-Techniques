void update(int elapsed){
	...
	//Increase/decrease tesselation value
	if (globs->keyset.find(SDLK_F1) != globs->keyset.end())
		Program::setUniform("tessFactor", globs->scale++);
	if (globs->keyset.find(SDLK_F2) != globs->keyset.end())
		Program::setUniform("tessFactor", globs->scale--);
}
